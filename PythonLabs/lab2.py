def print_even_numbers(max_number: int):  # 1 задание
    for x in range(2, max_number, 2):
        print(x, end=" ")


def calculate_arithmetic_mean(lst: list):  # 2 задание
    arithm_mean = 0
    for i in lst:
        arithm_mean += i
    arithm_mean /= len(lst)
...
def print_numbers(max_number: int):  # 10 задание
    for i in range(max_number, 0, -1):
        print(i, end=" ")


if __name__ == "__main__":
    print_even_numbers(10) #Тут вызвать любую функцию из задания